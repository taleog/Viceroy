...
lazy_static! {
    ...
    pub static ref CLIPBOARD_CACHE_DATA: Mutex<Vec<(String, String)>> = Mutex::new(Vec::new());
    pub static ref CLIPBOARD_CACHE_RESULTS: Mutex<Vec<search_engine::SearchResult>> =
        Mutex::new(Vec::new());
